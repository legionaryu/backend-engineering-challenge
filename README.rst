...
The Unbabel CLI is a command line tool that allows you to check the
moving average of the translation delivery time minute by minute.
It can parse a stream of json objects, arranged by line or in a
json array

Installation
____________

This software was developed and tested using Python 3.8.0 for Windows
